...
const unisex = Object.keys(findTop10EndingLetters([...unisexNames.map(name => normalizeString(name.toLowerCase()))]));
...
async function writeToFile() {
  try {
    const jsonString = compress(JSON.stringify(corpus)).trim();
